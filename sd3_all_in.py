...
from sd3_rf_inversion import encode_imgs, interpolated_inversion, decode_imgs
...
def process_directory(
    ...
    # Set up image transformation for SD3 (1024x1024)
...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='/shared/shashmi/stable-diffusion-3-medium-diffusers', help='Path to the SD3 model')
